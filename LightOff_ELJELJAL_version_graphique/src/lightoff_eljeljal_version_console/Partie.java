...
public class Partie {
    ...
    public Partie(int nb) {
        grille = new GrilleDeJeu(nb, nb); // Spécifiez les dimensions de la grille
        grille.melangerMatriceAleatoirement(20);
        nbCoups = 0;
    }
    ...
    public void lancerPartie() {
        ...
        while (!grille.cellulesToutesEteintes()) {
            ...
            if (Objects.equals(typeCoup, "L") || Objects.equals(typeCoup, "l")) {
                System.out.println("Quelle ligne éteindre ? : ");
                input = scanner.nextLine();
                coup = Integer.parseInt(input);
                grille.activerDesactiverLigneDeCellules(coup);
            }
            if (Objects.equals(typeCoup, "C") || Objects.equals(typeCoup, "c")) {
                System.out.println("Quelle colonne éteindre ? : ");
                input = scanner.nextLine();
                coup = Integer.parseInt(input);
                grille.activerDesactiverColonneDeCellules(coup);
            }
            if (Objects.equals(typeCoup, "D") || Objects.equals(typeCoup, "d")) {
                System.out.println("Quelle Diagonale éteindre ? Entrez la colonne : ");
                input = scanner.nextLine();
                coup = Integer.parseInt(input);
